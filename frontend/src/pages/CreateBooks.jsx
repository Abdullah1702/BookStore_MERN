...
export default function CreateBooks(){
  ...
  return (
    <div className='p-4'>
      ...
      {loading ? <Spinner /> : ''}
      <div className='flex flex-col border border-sky-500 rounded-xl w-[600px] p-4 mx-auto'>
        <div className='my-4'>
        ...
        <button className='p-2 bg-sky-400 m-8 text-white' onClick={handleSaveBook}>Save</button>
      </div>
    </div>
  )
}
